...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        # Resolve effective provider and backend URL for each model role.
        # Per-role overrides take precedence over the shared llm_provider/backend_url.
        quick_provider = (
        ...
        quick_url = self.config.get("quick_think_llm_backend_url") or self.config.get("backend_url")
        deep_url = self.config.get("deep_think_llm_backend_url") or self.config.get("backend_url")
